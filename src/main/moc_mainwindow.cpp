...
static const qt_meta_stringdata_MainWindow_t qt_meta_stringdata_MainWindow = {
	{
		...
		QT_MOC_LITERAL(1, 11, 28), // "on_pushButtonSuivant_clicked"
		QT_MOC_LITERAL(2, 40, 0),  // ""
		QT_MOC_LITERAL(3, 41, 30), // "on_pushButtonPrecedent_clicked"
		QT_MOC_LITERAL(4, 72, 28)  // "on_pushButtonQuitter_clicked"

	},
	"MainWindow\0on_pushButtonSuivant_clicked\0"
	"\0on_pushButtonPrecedent_clicked\0"
...
void MainWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
	if (_c == QMetaObject::InvokeMetaMethod)
	{
		...
		{
		case 0:
			_t->on_pushButtonSuivant_clicked();
			break;
		case 1:
			_t->on_pushButtonPrecedent_clicked();
			break;
		case 2:
			_t->on_pushButtonQuitter_clicked();
			break;
		default:;
		}
	}
